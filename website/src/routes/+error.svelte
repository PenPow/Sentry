<main class="mx-auto w-full max-w-7xl px-6 pb-16 pt-10 sm:pb-24 lg:px-8">
	<a href="/"
		...
		/></a
	>
	<div class="mx-auto mt-8 max-w-2xl text-center sm:mt-12">
		<p class="text-base font-semibold leading-8 text-blurple-50">404</p>
		<h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">
			This page does not exist
		</h1>
		<p class="mt-4 text-base leading-7 color-gray-600 sm:mt-6 sm:text-lg sm:leading-8">
	...
	<div class="mx-auto mt-16 flow-root max-w-lg sm:mt-20">
		<ul class="-mt-6">
			<li class="relative flex gap-x-6 py-6">
				<div class="flex h-10 w-10 flex-none items-center justify-center rounded-lg shadow-sm">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 24 24"
						fill="currentColor"
						aria-hidden="true"
						class="h-6 w-6 text-blurple-50"
						><path
							fill-rule="evenodd"
			...
			<li class="relative flex gap-x-6 py-6">
				...
				<div class="flex-auto">
					<h3 class="text-sm font-semibold leading-6 text-gray-900">
						<a href="https://sentry-docs.penpow.dev/docs/welcome"><span class="absolute inset-0" aria-hidden="true" />Documentation</a>
					</h3>
					<p class="mt-2 text-sm leading-6 color-gray-600">View our documentation</p>
				</div>
				<div class="flex-none self-center">
					<svg
						xmlns="http://www.w3.org/2000/svg"
			...
			<li class="relative flex gap-x-6 py-6">
				...
				<div class="flex-auto">
					<h3 class="text-sm font-semibold leading-6 text-gray-900">
						<a href="https://sentry-docs.penpow.dev/blog"><span class="absolute inset-0" aria-hidden="true" />Blog</a>
					</h3>
					<p class="mt-2 text-sm leading-6 color-gray-600">Check out the latest posts</p>
				</div>
				<div class="flex-none self-center">
					<svg
						xmlns="http://www.w3.org/2000/svg"
		...
		<div class="mt-10 flex justify-center">
			<a href="/" class="text-sm font-semibold leading-6 text-blurple-50"
