...
description: This is an RFC proposed to overhaul our permissions system
---

<Callout type="warning"> 

<b>Unreleased Feature</b>
...
<Image 
	src="/static/docs/permissions-v2/flow.png" 
	alt="Diagram showing updated permission flow"
	width={907}
	height={859}
	quality={100}
	priority
...
> There is a simple test to determine whether somebody can be considered a "trusted" admin - the ability to slap them in the face...<br/>
